  ...
  return (
    <div className="siContainer">
      <div className="siWrapper">
        <img
          src="https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F28%2F2017%2F10%2Fguest-room-hotel-president-wilson-geneva-EXPENSIVESUITE1017.jpg"
          alt=""
          className="siImg"
        />
        <div className="siItemDesc">
          <h1 className="siTitle">Boutique hotels</h1>
          <span className="siDistance">10km from center</span>
